            ...
            <View style={styles.contentWrapper}>
                ...
                <View style={styles.userWrapper}>
                        <View style={styles.userItem1}>
                            <View style={styles.userItem1InnerWrapper}>
                            <Image source={require('../assets/images/userImage.jpg')} style={styles.userItem1Inner1}>
                                
                            </Image>
                            <View style={styles.userItem1Inner2}>
                                <View style={styles.userItem1Inner2Wrapper}>
                                    <View style={styles.userItem1Inner2WrapperItem1}>
                                    <MatIcon style={styles.closeIconWrapper} name="sofa-outline" color="#f9f9f9" size={18} />
                                    </View>
                                    <View style={styles.userItem1Inner2WrapperItem2}>
                                    <MatIcon style={styles.closeIconWrapper} name="sofa-outline" color="#f9f9f9" size={18} />
                                    </View>
                                </View>
                            </View>
                    ...
                    <View style={styles.peopleNumbers}>
                        ...
                        <View style={styles.activePeople}><IonIcon name='people' color={'white'} size={24}/><Text style={styles.peopleNumberText}>6</Text></View>
                        ...
                        <View style={styles.peopleNumberWrapper}><IonIcon name='people' color={'white'} size={20}/><Text style={styles.peopleNumberText}>12</Text></View>
                    </View>
