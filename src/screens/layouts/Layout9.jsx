                ...
                <View style={styles.userWrapper}>
                        <View style={styles.userItem2}>
                            <View style={styles.userItem2InnerWrapper}>
                                <Image source={require('../assets/images/userImage.jpg')} style={styles.userItem2Inner1}>
                                </Image>
                    ...
                    <View style={styles.peopleNumbers}>
                        ...
                        <View style={styles.activePeople}><IonIcon name='people' color={'white'} size={24}/><Text style={styles.peopleNumberText}>9</Text></View>
